...
export default function Login() {
  ...
  return (
    <div className="container flex h-screen">
      <div className="Login-btn-group w-1/2 p-5 flex">
        <div className="form-container w-full m-auto">
          ...
          <div className="Sign-in flex justify-center">
            <h1 className="font-bold text-xl">Sing in</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="Login-form m-auto">
            <div>
              ...
              <div className="Input-email mt-2">
                <input
                  ...
                  className="bg-gray-100 rounded-md h-10 w-full border-2 border-solid border-black-100"
                ></input>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="bg-green-400 flex w-full h-10 items-center rounded-xl px-4 mt-5 hover:bg-green-800"
            >
      ...
      <div className="Some-picture w-1/2 p-5 bg-[url('https://littlevisuals.co/images/i.o.jpg')] bg-cover"></div>
    </div>
  );
}
